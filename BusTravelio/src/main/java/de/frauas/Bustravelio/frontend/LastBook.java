...
ButtonGroup gengp=new ButtonGroup(); 
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(usernemeTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, 290, 50));
        ...
        kGradientPanel1.add(passwordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 300, 290, 50));
        ...
        kGradientPanel1.add(spotCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 170, 220, -1));
        ...
        kGradientPanel1.add(usernemeTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 310, 290, 50));

        gengp.add(luxcoinCheckBox);
        luxcoinCheckBox.setFont(new java.awt.Font("Avenir Next", 0, 18)); // NOI18N
        luxcoinCheckBox.setText("pay with TravelIO coin");
        kGradientPanel1.add(luxcoinCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 261, -1));
        ...
        kGradientPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 160, -1, 53));
        ...
        kGradientPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, -1, -1));

        jLabel9.setFont(new java.awt.Font("Avenir Next", 0, 24)); // NOI18N
        jLabel9.setText("TravelioCoin");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 220, 154, -1));
        ...
        kGradientPanel1.add(labelfrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 130, 30));

        jLabel11.setFont(new java.awt.Font("Avenir Next", 0, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("E-Mail address");
        kGradientPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 270, 190, -1));

        jLabel12.setFont(new java.awt.Font("Avenir Next", 0, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Username ");
        kGradientPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 270, 154, -1));

        jLabel13.setFont(new java.awt.Font("Avenir Next", 0, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Password");
        kGradientPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 270, 154, -1));

        jLabel14.setFont(new java.awt.Font("Avenir Next", 1, 24)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Amount payable:");
        kGradientPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 160, 250, 53));

        LuxcoinLabel1.setFont(new java.awt.Font("Ayuthaya", 1, 36)); // NOI18N
        LuxcoinLabel1.setText("TravelioCoin");
        kGradientPanel1.add(LuxcoinLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 540, 270, 54));

        jLabel15.setFont(new java.awt.Font("Avenir Next", 0, 13)); // NOI18N
        jLabel15.setText("Payment now one step easier ");
        kGradientPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 600, 390, -1));

        jLabel16.setIcon(new javax.swing.ImageIcon("C:\\Users\\Janny\\Desktop\\ikons\\bus.png")); // NOI18N
        kGradientPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, -10, -1, -1));

        jLabel17.setIcon(new javax.swing.ImageIcon("C:\\Users\\Janny\\Desktop\\ikons\\money.png")); // NOI18N
        kGradientPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 490, -1, -1));
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        if (luxcoinCheckBox.isSelected()){
            ...
            else if (!mydbhandler.checkstatmentExsist(checkSec))
            {
                ...
                String sentOrReceived = "Received for Ticket";
                String sentTo = "----";
                String received = "TravelIO Payment";
     ...
     //           mydbhandler.insertUserstoryT(username, fromcity, tocity, Datum, departureTime, arriveTime, price,seat);
            ...
            String nachricht = "thank you for your booking , here below you can see the booking information.\n\n";
                String info7 = "\n\nplease be there at least 10 minutes early\n\n";
                ...
                String path = "C:\\Users\\Janny\\Downloads\\" + username + date + ".pdf";
                String subject = "Your Ticket";
                String info = "Hello\nnice that you use TravelO and grab the opportunity to buy tickets cheap and invest in traveliocoin at the same time.\n\n\n You see your Ticket information attached with this mail as pdf\n\n\n";
            ...
            DBHandler mydbhandler= new DBHandler();
             ...
             String nachricht = "Thank you for your booking , here below you can see the booking information.\n\n";
                String info7 = "\n\nplease be there about 10 minutes early\n\n";
                ExportPDF export = new ExportPDF();
                ...
                String path = "C:\\Users\\Janny\\Downloads\\" + username + Datum + ".pdf";
                String subject = "Your Ticket";
                String info = "Welcome ,\n" +
